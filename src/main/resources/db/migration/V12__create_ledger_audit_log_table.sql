...
CREATE TABLE IF NOT EXISTS billing_ledger_audit_log (
    ...
    charging_invoice_id     BIGINT NOT NULL REFERENCES charging_invoices(id) ON DELETE RESTRICT,
...
CREATE INDEX IF NOT EXISTS idx_ledger_audit_tx_link ON billing_ledger_audit_log (charging_invoice_id, created_at ASC);
