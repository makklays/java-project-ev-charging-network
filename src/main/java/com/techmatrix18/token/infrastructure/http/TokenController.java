...
public class TokenController {
     ...
     */
    @PostMapping("/tokens")
    public ResponseEntity<TokenResponse> issueTokens(@RequestBody IssueTokenCommand command) {
     ...
     */
    @PostMapping("/refresh")
    public ResponseEntity<TokenResponse> refreshTokens(@RequestBody RefreshTokenCommand command) {
     ...
     */
    @PostMapping("/logout")
    public ResponseEntity<Void> revokeToken(@RequestBody RevokeTokenCommand command) {
